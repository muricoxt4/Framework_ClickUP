...
> Sistema de gestão desenvolvido e operado em uma **agência de comunicação** com carteira multissetorial, utilizando o **ClickUp** como plataforma central de organização, produção e acompanhamento de clientes e equipes.
